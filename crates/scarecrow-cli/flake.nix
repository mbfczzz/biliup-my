  ...
  outputs = { self, nixpkgs, crane, flake-utils, rust-overlay, ... }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        frontend = pkgs.runCommand "scarecrow-frontend-empty" {} ''
          mkdir -p $out
      ...
      in
      {
        checks = {
          ...
          scarecrow-clippy = craneLib.cargoClippy (commonArgs // {
            inherit cargoArtifacts;
            cargoClippyExtraArgs = "--all-targets -- --deny warnings";
          });

          # Check formatting
          scarecrow-fmt = craneLib.cargoFmt {
        ...
        apps = {
          default = flake-utils.lib.mkApp {
            drv = scarecrow;
            exePath = "/bin/scarecrow";
          };
          scarecrow = flake-utils.lib.mkApp {
            drv = scarecrow;
            exePath = "/bin/scarecrow";
          };
        };
