...
use scarecrow_core::error::Kind;
use scarecrow_core::uploader::bilibili::{BiliBili, Studio, Vid, Video};
use scarecrow_core::uploader::credential::{Credential, LoginInfo};
use scarecrow_core::uploader::line::Probe;
use scarecrow_core::uploader::util::SubmitOption;
use scarecrow_core::uploader::{VideoFile, credential, line, load_config};
use bytes::{Buf, Bytes};
use clap::ValueEnum;
use dialoguer::Input;
...
pub async fn upload(
    ...
    for video_path in video_path {
        ...
        let uploader = {
            ...
            scarecrow_core::retry_with_config(
                || async {
