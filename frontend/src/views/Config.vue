...
.config-icon { width:40px; height:40px; border-radius:10px; background:rgba(59,130,246,.08); color:var(--c-accent); display:flex; align-items:center; justify-content:center; margin-bottom:16px; }
